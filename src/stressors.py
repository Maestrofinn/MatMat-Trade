...
MATERIAL_STRESSOR_NAMES=["Bauxite et aluminium","Cuivre","Or","Fer","Plomb","Nickel","Autres métaux non-ferreux","Platine","Argent",
                         "Cassitérite","Uranium et thorium","Zinc","Pierre de construction","Minéraux chimiques et d'engrais",
                         "Argiles et kaolin","Gravier et sable","Calcaire, gypse, craie, dolomite","Autres minéraux","Sel","Ardoise"]
